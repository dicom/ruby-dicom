...
* Improved the handling ofparent-child relations so these are always properly updated when adding, removing or changing parent elements.
...
* Added alias_methods read? for read_success and written? for write_succes in DObject.
