...
module DICOM
  ...
  context "When handling Data Elements with tags as value (VR = 'AT')" do
  ...
  context "When handling Data Element tags" do
  ...
  context "When specifying or querying data elements using tags" do
